...
public class PostCreate_Activity extends AppCompatActivity {
    ...
    private void Init() {
        ...
        imbSelectPhoto = findViewById(R.id.postCreate_imbAddImage);
        imbCancel = findViewById(R.id.postCreate_imbCancel);

        edtND = findViewById(R.id.postCreate_edtND);
        rcvImage = findViewById(R.id.postCreate_rcvImage);

        btnDang = findViewById(R.id.postCreate_btnDang);
    ...
    private void Event() {
        ...
        btnDang.setOnClickListener(view -> {
            if (edtND.getText().toString().equals("") && listImageUri.size() == 0) {
                Toast.makeText(PostCreate_Activity.this, "Nhập nội dung cho bài viết", Toast.LENGTH_SHORT).show();
                return;
            }
            sendPost();
        });
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            if (listImageUri.size() > 0) {
                                ...
                                Toast.makeText(PostCreate_Activity.this, "Đăng bài thành công !", Toast.LENGTH_SHORT).show();
                            } else {
                                progressDialog.dismiss();
                                Toast.makeText(PostCreate_Activity.this, "Đăng bài thành công !", Toast.LENGTH_SHORT).show();
                                listImageUri.clear();
                            ...
                            Toast.makeText(PostCreate_Activity.this, "Đã có lỗi xảy ra trong quá trình đăng bài", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
            ...
            if (uri != null) {
                ...
                uploadTask.addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception exception) {
                        ...
                        Toast.makeText(PostCreate_Activity.this,"Lưu ảnh thất bại",Toast.LENGTH_SHORT).show();
                        Log.d("post","thatbai");
                    }
    ...
    private void openCancelPostDialog() {
        ...
        btnBo.setOnClickListener(view -> {
            dialog.dismiss();
            PostCreate_Activity.this.finish();
        });
        dialog.create();
        dialog.show();
    }
    ...
    private void requestPermission() {
        ...
        PermissionListener permissionlistener = new PermissionListener() {
            ...
            public void onPermissionDenied(List<String> deniedPermissions) {
                Toast.makeText(PostCreate_Activity.this, "Permission Denied\n" + deniedPermissions.toString(), Toast.LENGTH_SHORT).show();
            }
        };
